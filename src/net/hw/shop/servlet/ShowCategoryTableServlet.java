...
@WebServlet("/showCategoryTable")
public class ShowCategoryTableServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       CategoryService categoryService = new CategoryService();
        ...
        response.sendRedirect(request.getContextPath() + "/web/backend/showCategory.jsp");
